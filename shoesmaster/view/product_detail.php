            ...
            <div class="row">
                                ...
                                <div class="single_prodct">
                                    <ul class="nav nav-tabs justify-content-center mb-55" id="dfde" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#homde" type="button" role="tab" aria-selected="true"><img src="./view/assets/img/product/17.jpg" alt=""></button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profidfdle" type="button" role="tab" aria-selected="false"><img src="./view/assets/img/product/17-1.jpg" alt=""></button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#contadfdct" type="button" role="tab" aria-selected="false"><img src="./view/assets/img/product/17-2.jpg" alt=""></button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="kids-tab" data-bs-toggle="tab" data-bs-target="#kidsdfd" type="button" role="tab" aria-selected="false"><img src="./view/assets/img/product/17-3.jpg" alt=""></button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-10 col-lg-10 col-md-10">
                            <div class="single_preview_product">
                                <div class="single-popup-view">
                                    <a class="popup-image" href="./view/assets/img/product/17-3.jpg"><i class="fal fa-search"></i></a>
                                </div>
                                <div class="tab-content" id="myTabefContent">
                                    ...
                                    <div class="tab-pane fade" id="profidfdle" role="tabpanel">
                                        <div class="full-view">
                                            <img src="./view/assets/img/product/17-1.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="contadfdct" role="tabpanel">
                                        <div class="full-view">
                                            <img src="./view/assets/img/product/17-2.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="kidsdfd" role="tabpanel">
                                        <div class="full-view">
                                            <img src="./view/assets/img/product/17-3.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="single_preview_content pl-30">
                        <h2 class="title-5 edit-title border-bottom-0"><?= $name ?></h2>
                        ...
                        <div class="s-price pt-30 mb-30">
                            <span><?= $price ?></span><del><?= $price2 ?></del>
                        </div>
                        <div class="s-des">
                            <p>Designed by Hans J. Wegner in 1949 as one of the first models created especially for Carl Hansen & Son, and produced since 1950. The last of a series of chairs Wegner designed based on inspiration from antique Chinese armchairs.
                                The gently rounded top together with the back and seat offers a</p>
                        </div>
                        <div class="viewcontent__action single_action pt-30">
                            <form action="index.php?pg=addcart" method="post">
                            <span><input type="number" id="" class="input-text qty"name="soluong" value="1" min="1" max="10" /></span>
                            <input type="hidden" name="idpro" value="<?= $idpro ?>">
                                                     ...
                                                     <span>   <input   type="submit" name="addcart" value="Đặt hàng"></span>
                        ...
                        <div class="tab-content" id="myTabCffontent">
                            <div class="tab-pane fade show active" id="Description" role="tabpanel">
                                <div class="single_product_description text-center pt-80">
                                    ...
                                    <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit <br> voluptatem accusantium doloremque laudantium, totam
                                        rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt <br> explicabo. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                                    <div class="desc__imag pt-70">
                                        <img src="./view/assets/img/desc/des1.jpg" alt="">
                                    </div>
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-12">
                                            <div class="desc__imag_2">
                                                <img src="./view/assets/img/desc/images-d1.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 pl-50">
                                            ...
                                            <div class="desc_image_content pt-30 mb-30">
                                                <div class="desc-3_image">
                                                    <img src="./view/assets/img/desc/d1.jpg" alt="">
                                                </div>
                                            ...
                                            <div class="desc_image_content mb-30">
                                                <div class="desc-3_image">
                                                    <img src="./view/assets/img/desc/d2.jpg" alt="">
                                                </div>
                                                <div class="desc-3_content">
                                            ...
                                            <div class="desc_image_content mb-30">
                                                <div class="desc-3_image">
                                                    <img src="./view/assets/img/desc/d3.jpg" alt="">
                                                </div>
                                                <div class="desc-3_content">
                                    ...
                                    <div class="show_product">
                                        <div class="desc__imag pt-70">
                                            <img src="./view/assets/img/desc/des2.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="show_product">
                                        <h2 class="title-5 border-0 pt-30">YOUR NEW AND IMPROVED​</h2>
                                        <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit <br> voluptatem accusantium doloremque laudantium,
                                            totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt <br> explicabo. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat
                                            nulla pariatur.</p>
                                        <div class="desc__imag pt-70">
                                            <img src="./view/assets/img/desc/des3.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="show_product">
                                    ...
                                    <div class="row pt-100">
                                        <div class="col xl-4 col-lg-4 col-md-4 col-sm-12">
                                            <div class="show_model_product mb-30">
                                                <img src="./view/assets/img/desc/a1.jpg" alt="">
                                                <h4 class="pb-30">women’s running</h4>
                                                <img src="./view/assets/img/desc/b1.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col xl-4 col-lg-4 col-md-4 col-sm-12">
                                            <div class="show_model_product mb-30">
                                        ...
                                        <div class="col xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            <div class="show_model_product mb-30">
                                                ...
                                                <img src="./view/assets/img/desc/b3.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                                ...
                                                                <div class="product-active swiper-container">
                                                                    ...
                                                                    foreach ($splienquan as $item) {
                                                                        ...
                                                                        if ($price > 0) {
                                                                            ...
                                                                            $gia = ' <span class="product-pricce">Đang cập nhật</span>';
                                                                        }
                                                                        if ($price2 > 0) {
                                                                        ...
                                                                        //   if($new==1){
                                                                        //     $newlabel='<span class="text-uppercase">New</span>';
                                                                        //   }else{
                                                                        //     $newlabel='';
                                                                        //   }
                                            ...
                                            <div class="product__reviews_comment pt-150">
                                                ...
                                                <div class="user_design">
                                                    <div class="user__thumb">
                                                        <img src="./view/assets/img/desc/team2-60x60.png" alt="">
                                                    </div>
